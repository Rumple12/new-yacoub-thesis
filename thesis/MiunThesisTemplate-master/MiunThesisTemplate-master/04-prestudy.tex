...
PC-hosted n8n was chosen for stability, repeatability, and reduced deployment risk. The local Docker-based setup provides a consistent workflow runtime and avoids making the thesis dependent on whether n8n itself can be optimized for Raspberry Pi hardware. The workflow comparison can then focus on behavior and measurement rather than on platform-specific installation issues \cite{n8nDocs,dockerDocs}.
